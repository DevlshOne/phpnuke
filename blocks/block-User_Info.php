	...
	<div class=\"statistic\">";
		...
		if(!empty($statistics_contents['online_members']))
		{
			foreach($statistics_contents['online_members'] as $online_member)
				$content .= "<li class=\"list-group-item\">".$online_member['where'].".&nbsp; <a href=\"".$online_member['profile']."\">".$online_member['username']."</a> <span class=\"badge\">".$online_member['user_posts']."</span></li>";
		}
		$content .= "</ul>
