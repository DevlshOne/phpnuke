...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000625fc1810000000008cef374(
...
class phpbbtemplatetwiglexer_00000000625fc1810000000008cef374 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5981db781f890355781005 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5981db781f8a4503106352 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5981db781f85e461645450 = array(
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, 'set_environment', array('env' => $env), $this->initializer5981db781f8a4503106352);

        return $this->valueHolder5981db781f890355781005->set_environment($env);
    }
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5981db781f8a4503106352);

        return $this->valueHolder5981db781f890355781005->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5981db781f8a4503106352);

        return $this->valueHolder5981db781f890355781005->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5981db781f8a4503106352 = $initializer;
    }
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__get', array('name' => $name), $this->initializer5981db781f8a4503106352);

        if (isset(self::$publicProperties5981db781f85e461645450[$name])) {
            return $this->valueHolder5981db781f890355781005->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5981db781f890355781005;
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5981db781f8a4503106352);
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__isset', array('name' => $name), $this->initializer5981db781f8a4503106352);
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__unset', array('name' => $name), $this->initializer5981db781f8a4503106352);
    ...
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__clone', array(), $this->initializer5981db781f8a4503106352);

        $this->valueHolder5981db781f890355781005 = clone $this->valueHolder5981db781f890355781005;
    }

    public function __sleep()
    {
        $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, '__sleep', array(), $this->initializer5981db781f8a4503106352);

        return array('valueHolder5981db781f890355781005');
    }
    ...
    {
        return $this->initializer5981db781f8a4503106352;
    }
    ...
    {
        return $this->initializer5981db781f8a4503106352 && $this->initializer5981db781f8a4503106352->__invoke($this->valueHolder5981db781f890355781005, $this, 'initializeProxy', array(), $this->initializer5981db781f8a4503106352);
    }
    ...
    {
        return null !== $this->valueHolder5981db781f890355781005;
    }
    ...
    {
        return $this->valueHolder5981db781f890355781005;
    }
