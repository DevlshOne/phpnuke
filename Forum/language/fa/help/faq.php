...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=>  '"حذف کوکی های تالا" همه کوکی هایی را که phpbb از آن برای وارد نگه داشتن شما در تالار استفاده میکند را پاک خواهد کرد. همچنین کوکی ها عملکرد های دیگری نیز دارند. اگر در ورود و خروج مشکلی دارید،حذف کوکی ها میتواند مشکل شما را حل کند.',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'معنی حذف کوکی های تالار چیست ؟',
