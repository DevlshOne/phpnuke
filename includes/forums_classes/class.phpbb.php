...
class users_system{
	...
	public function user_statistics()
	{
		...
		if (is_user())
		{
			...
			if ($useavatars == 1)
				$your_avatar = $this->get_gravatar_url($this->data, $this->data['user_avatar_width'], $this->data['user_avatar_height']);
	...
	public function get_gravatar_url($row, $width=100, $height=100)
	{
	...
	public function get_login_form_data($html=true, $options = array())
	{
		...
		$login_form = array(
				...
				"inputs"		=> array(
					...
					"hidden"		=> array("sid" => $this->session_id),
