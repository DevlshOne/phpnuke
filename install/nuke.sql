...
`mid` int(10) NOT NULL,
  ...
  `all_blocks` int(1) NOT NULL,
  `main_module` int(1) NOT NULL,
...
`nav_id` int(11) NOT NULL,
  ...
  `lang_nav_title` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(21, 'فهرست اصلی', 'a:2:{s:7:"english";s:11:"main navbar";s:5:"farsi";s:19:"فهرست سایت";}', 'primary', 1, '1496770474');
...
`pollID` int(11) NOT NULL,
  ...
  `main_survey` tinyint(1) NOT NULL,
  `module` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `to_main` tinyint(1) NOT NULL,
  `allow_comment` tinyint(1) NOT NULL,
  `comments` int(11) DEFAULT '0',
  `options` text COLLATE utf8mb4_unicode_ci,
  `multi_vote` tinyint(1) NOT NULL,
  `show_voters_num` tinyint(1) NOT NULL,
  `permissions` text COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
