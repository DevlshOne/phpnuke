...
if (check_admin_permission($filename))
{
	...
	function settings()
	{
		...
		$contents .= "<div id=\"container\">
            <ul>
                <li><a href=\"".$admin_file.".php?op=general_config\"><span>"._GENERAL."</span></a></li>
                <li><a href=\"".$admin_file.".php?op=themes_config\"><span>"._THEMES."</span></a></li>
                <li><a href=\"".$admin_file.".php?op=comments_config\"><span>"._COMMENTS."</span></a></li>
                <li><a href=\"".$admin_file.".php?op=language_config\"><span>"._LANGUAGES."</span></a></li>
                <li><a href=\"".$admin_file.".php?op=referers_config\"><span>"._REFERRERS."</span></a></li>
				...
				if(isset($other_admin_configs) && is_array($other_admin_configs) && !empty($other_admin_configs))
				{
					foreach($other_admin_configs as $config_name => $config_data)
					{
						...
						if(isset($config_data['title']))
							$contents .="<li><a href=\"".$admin_file.".php?op=others_config&other_admin_config=$config_name\"><span>".$config_data['title']."</span></a></li>";
					}
				}
            $contents .= "</ul>
		</div>
	...
	function save_configs($submit, $config_fields, $return_op = 'settings', $log_message = '', $array_level = array())
	{
		...
		if(isset($submit) && isset($config_fields))
		{
			...
			header("location:".$admin_file.".php?op=$return_op");
		}	
	}
	...
	function general_config()
	{
		...
		$contents .="</td></tr>
		<tr><td>&nbsp;</td><td halign=\"left\"><input type='hidden' name='op' value='save_configs'>
