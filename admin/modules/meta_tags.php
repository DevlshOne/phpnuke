...
if (check_admin_permission($filename))
{
	function seo()
	{
		...
		$contents .= "<input type='hidden' name='op' value='saveseo'>"
		...
		."<tr><td><input type='hidden' name='op' value='savesets'><input class=\"form-submit\" type='submit' value='" . _SAVECHANGES . "'>"
		."</td></tr></table></form>";
		$contents .= "</div>";
		...
		$contents .= "<tr><td><input type='hidden' name='op' value='savepings'><input class=\"form-submit\" type='submit' value='" . _SAVECHANGES . "'>
		</td></tr></table></form>
		</table>";
