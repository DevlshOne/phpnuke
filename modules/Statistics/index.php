...
function statistics()
{
	...
	{
		$result = $db->query("SELECT ".$users_system->user_fields['user_regdate']." FROM ".$users_system->users_table." WHERE ".$users_system->user_fields['user_regdate']." >= :last_month AND ".$users_system->user_fields['user_regdate']." <= :now_time AND ".$users_system->user_fields['common_where']."", array(":last_month" => $last_month, ":now_time" => $now_time));
			...
			<div class=\"col-md-12\">
				...
				<div class=\"text-center\" dir=\""._DIRECTION."\">
					...
					<div class=\"stats_info\">
						".sprintf(_PAGES_VIEWED_BY, $total_hits, $total_visitors)."
						<br />
