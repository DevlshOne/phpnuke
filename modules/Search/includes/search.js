...
{$("#search_category_html").fadeIn();$.post(phpnuke_url+"index.php?modname=Search",{op:"search_categories",selected_category:selected_category,module:module_name},function(data,status){$("#search_category").html('<option value="0">'+search_language.all_categories+'</option>'+data)})}
