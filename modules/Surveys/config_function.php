...
function surveys_link($pollID, $pollTitle = '', $pollUrl = '')
{
	...
	if($pollUrl == '')
	{
		...
		$pollUrl = get_unique_post_slug(SURVEYS_TABLE, "pollID", $pollID, "article_url", $pollUrl);
...
$nuke_configs_links_function['Surveys'] = "surveys_link";
...
$nuke_configs_statistics_data['Surveys'] = array(
	"total_surveys" => array(
		"title"				=> "_SURVEYS",
		"table"				=> SURVEYS_TABLE,
		"count"				=> "pollID",
