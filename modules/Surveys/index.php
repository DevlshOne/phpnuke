...
function pollList()
{
	...
	include("header.php");
	$html_output .= show_modules_boxes($module_name, array("bottom_full", "top_full","left","top_middle","bottom_middle","right"), $contents, "", array("block-comments.php"));
	include ("footer.php");
}
...
function poll_show($pollUrl, $mode="")
{
	...
	$html_output .= show_modules_boxes($module_name, array("bottom_full", "top_full","left","top_middle","bottom_middle","right"), "<div class=\"surveys\">".$contents."</div>");
